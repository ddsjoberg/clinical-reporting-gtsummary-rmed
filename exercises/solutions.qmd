...
adj_difference <-
  inline_text(gts_death_adjusted,
              variable = death,
              pattern = "difference {estimate}; 95% CI {ci}; {p.value}")
# adj_qsmk_or <-
#   inline_text(gts_mod,
...
On univariate analysis, participants who did not quit smoking had higher rates of death (`r unadj_difference`). However, on multivariable analysis, the relationship was not longer significant (`r adj_difference`).

We can also report the results from the multivariable logistic regression model: however, on multivariable analysis, the relationship was not longer significant (`r adj_qsmk_or`).

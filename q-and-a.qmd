...
4.  **Q:** how do you display average instead of median
...
> Use the selectors all_continuous(), etc
...
10. **Q:** I would be great an "asterisk_p" to show significant p-values, like bold_p

>  add_significance_stars, <https://www.danieldsjoberg.com/gtsummary/reference/add_significance_stars.html>

11. **Q:** if there are more than two groups, is there any function for post hoc testing?

>  Here are supported tests: <https://www.danieldsjoberg.com/gtsummary/reference/tests.html>.  Post hoc tests might require custom testing. There are some relevant questions on SO that may be useful.

12. **Q:** Can gtsummary give Baysesian statistics result ?
...
>  `modify_table_styling()` https://www.danieldsjoberg.com/gtsummary/reference/modify_table_styling.html or `add_estimate_to_reference_rows = TRUE`
...
17. **Q:** Can you `add_global_p()` without removing p() for each category?
...
>  Some issues with dummy variables but we are working on it for future release
...
>  Not currently supported but see <https://github.com/ddsjoberg/gtsummary/issues/1280>
...
25. **Q:** So if I change the CI to 90%, I need to update the pattern to 90% CI {ci} right?
